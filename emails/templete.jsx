          ...
          <Container style={styles.container}>
            ...
            <Section style={styles.statsContainer}>
              ...
              <div style={styles.stat}>
                ...
                <Text style={styles.heading}>${expenseValue}</Text>
              </div>
              <div style={styles.stat}>
            ...
            {insights.length > 0 && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>Budgetra Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using Budgetra. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
